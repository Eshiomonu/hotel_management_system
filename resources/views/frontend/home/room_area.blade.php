            ...
            <div class="col-lg-5 col-md-4 p-0">
              <div class="room-card-img">
                <a href="room-details.html">
                  <img src="{{asset('frontend/assets/img/room/deluxe9.jpg')}}" alt="Images">
                </a>
              </div>
            </div>
        ...
        <div class="room-card-two">
          <div class="row align-items-center">
            <div class="col-lg-5 col-md-4 p-0">
              <div class="room-card-img">
                <a href="room-details.html">
                  <img src="{{asset('frontend/assets/img/room/standard1.jpg')}}" alt="Images">
                </a>
              </div>
            </div>
        ...
        <div class="room-card-two">
          <div class="row align-items-center">
            <div class="col-lg-5 col-md-4 p-0">
              <div class="room-card-img">
                <a href="room-details.html">
                  <img src="{{asset('frontend/assets/img/room/deluxe13.jpg')}}" alt="Images">
                </a>
              </div>
            </div>
        ...
        <div class="room-card-two">
          <div class="row align-items-center">
            <div class="col-lg-5 col-md-4 p-0">
              <div class="room-card-img">
                <a href="room-details.html">
                  <img src="{{asset('frontend/assets/img/room/deluxe6.jpg')}}" alt="Images">
                </a>
              </div>
            </div>
